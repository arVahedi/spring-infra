INSERT INTO users (id, first_name, last_name, email, status, deleted, created_date) VALUES (1, 'admin', '', 'admin@spring-infra.project', 1, FALSE, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

INSERT INTO credential (id, user_id, username, password, created_date) VALUES (1, 1, 'admin', '$argon2id$v=19$m=4096,t=3,p=1$QnVwdGpUVmR3OUtHV29Pdw$QDBYFDfx9ePp6PwjP95woA', CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

INSERT INTO users (id, first_name, last_name, email, status, deleted, created_date) VALUES (2, 'user', '', 'user@spring-infra.project', 1, FALSE, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

INSERT INTO credential (id, user_id, username, password, created_date) VALUES (2, 2, 'user', '$argon2id$v=19$m=4096,t=3,p=1$QnVwdGpUVmR3OUtHV29Pdw$QDBYFDfx9ePp6PwjP95woA', CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO credential_role (credential_id, role_id, created_date)
