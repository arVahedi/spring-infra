 ...
 *
 * @see springinfra.configuration.security.WebSecurityConfig
 */
@Order(99)
public abstract class BaseIdentityProviderModuleConfig implements BaseConfig {
     ...
     * by {@link springinfra.configuration.security.WebSecurityConfig#authenticationManager(AuthenticationConfiguration) this method}
     ...
     * To fix this issue we have to disable the logout feature of HttpSecurity and then configure the logout logic manually. (For further information take a look at {@link springinfra.configuration.security.WebSecurityConfig#createLogoutFilter(HttpSecurity)}
