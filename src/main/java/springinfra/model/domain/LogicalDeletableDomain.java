 ...
 * will be handled in the logical deletion way automatically, thanks to {@link springinfra.database.listener.EnhancedDeleteEventListener}.
 *
 * @param <I> the type of identity of entity which should be a subclass of {@link Number}
 * @see springinfra.database.listener.EnhancedDeleteEventListener
 */
