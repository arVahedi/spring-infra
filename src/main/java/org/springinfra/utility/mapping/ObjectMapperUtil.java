package org.springinfra.utility.mapping;


import lombok.experimental.UtilityClass;
import lombok.extern.slf4j.Slf4j;
import org.springinfra.SpringContext;
import org.springinfra.exception.ObjectMappingException;
...
public class ObjectMapperUtil {
    ...
    public void applyMapToObject(Map<String, Object> valuesMap, Object destinationObject) {
            ...
            try {
                ...
                if (getterMethod.isPresent() && setterMethod.isPresent()) {
                    if (value != null && Map.class.isAssignableFrom(value.getClass())) {
                        ...
                        applyMapToObject((Map<String, Object>) value, innerObject);
                    } else {
