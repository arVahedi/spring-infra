...
import org.springinfra.utility.cryptographic.JksUtil;
...
public class JwtUtil {
    ...
    static {
        try {
            ...
            KeyStore keyStore = JksUtil.getKeyStore(JksUtil.KeyStoreType.JKS, "spring-infra.jks", "123456");
            KeyPair keyPair = JksUtil.getKeyPair(keyStore, "Spring-infra", "123456");
